...
// ── Main export ───────────────────────────────────────────────────────────────
export async function recordToSheets(params) {
    ...
    return {
        content: [
            {
                type: "text",
                text: `📊 Selesai mencatat ke Google Sheets (tab: ${year})\n\n` +
...
async function getExistingEmailIds(sheets, spreadsheetId, year) {
    try {
